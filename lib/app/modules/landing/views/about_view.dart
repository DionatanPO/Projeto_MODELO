  ...
  Widget _buildMission(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Text(
            'Nascemos da necessidade de simplificar o que é complexo. No Projeto MODELO, nossa missão é democratizar o acesso a ferramentas de gestão de alta performance para empresas de todos os tamanhos.',
            textAlign: TextAlign.center,
            style: GoogleFonts.inter(
